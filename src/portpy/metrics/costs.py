...
register(
    Explanation(
        ...
        caveats="Weight-based turnover does not estimate actual execution costs. It ignores market impact, spreads, commissions, taxes, leverage changes, and liquidity constraints.",
...
register(
    Explanation(
        ...
        caveats="The estimate assumes a simplified constant transaction cost. Real trading costs vary with liquidity, order size, market conditions, execution method, and asset characteristics.",
